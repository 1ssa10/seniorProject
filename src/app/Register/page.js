  ...
  return (
    <div className=" flex items-center justify-center h-screen ">
      <div className=" bg-black relative overflow-hidden">
        <div className=" absolute backdrop-blur-sm bg-transparent h-screen w-full overflow-hidden z-10">
      ...
      <div className=" absolute z-10 w-1/2">
        <section className=" relative bg-transparent dark:bg-gray-900">
          <div className="w-1/2 flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <Link
              href="#"
